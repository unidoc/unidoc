...
func (j *JBIG2Encoder) DecodeStream(streamObj *PdfObjectStream) ([]byte, error) {
	// TODO: Set Globals
	return j.decodeBytes(streamObj.Stream)
...
// UpdateParams updates the pparams for the Encoder interface
func (j *JBIG2Encoder) UpdateParams(params *PdfObjectDictionary) {
}
